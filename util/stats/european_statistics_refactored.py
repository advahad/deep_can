...
def calc_sessions_fullness(sessions_path, results_dir):
...
def join_percent_empty_to_importance(percent_empty_dir_path, signals_importance_path):
    ...
    percent_empty = percent_empty.drop(['sid_id', 'session_len', 'vid', 'sid', 't_x', 'fid_x'], axis=1)
